...
export const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&_ng-icon]:pointer-events-none [&_ng-icon]:shrink-0 [&_ng-icon:not([class*='text-'])]:text-base",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground font-bold uppercase tracking-widest px-6 py-4 hover:bg-primary/90 ',
        destructive:
          'bg-destructive hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white',
        outline:
          'bg-transparent border-1 border-var(--zeito-surface-1) text-secondary-foreground font-bold uppercase tracking-widest hover:border-[var(--accent)] hover:text-[var(--accent)]',
        secondary:
          'bg-secondary text-secondary-foreground font-bold uppercase tracking-widest hover:bg-secondary/80',
        ghost:
          'text-secondary-foreground font-bold uppercase tracking-widest hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50',
        link: 'text-primary underline-offset-4 hover:underline',
        danger:
          'bg-[rgba(240,60,60,0.12)] text-[var(--danger)] border border-[rgba(240,60,60,0.3)] font-bold uppercase tracking-[0.08em] hover:bg-[rgba(240,60,60,0.2)]',
      },
      size: {
